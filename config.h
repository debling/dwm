...
static const char *cmdbrightnessdown[] = { "xbacklight", "-2", NULL };
static const char *cmdbrightnessup[]   = { "xbacklight", "+2", NULL };
static const char *cmdlock[]	       = { "loginctl", "lock-session", NULL };
static const char *cmdnext[]	       = { "playerctl", "next",  NULL };
static const char *cmdplay[]	       = { "playerctl", "play-pause",  NULL };
static const char *cmdprev[]	       = { "playerctl", "previous",  NULL };
static const char *cmdreboot[]	       = { "sudo", "reboot", NULL };
static const char *cmdshutdown[]       = { "sudo", "shutdown", "-h", "now", NULL };
...
static Key keys[] = {
	...
	{ 0,                            XF86TouchpadToggle,	   spawn,         {.v = cmdtouchpadtoggle } },
